...
from src.models.schemas import User, Question, PyObjectId
...
async def get_user_questions(type: Optional[str] = None, current_user: User = Depends(get_current_user), db=Depends(get_database)):
...
async def create_question(question: QuestionCreate, current_user: User = Depends(get_current_user), db=Depends(get_database)):
...
async def update_question(question_id: str, question: QuestionUpdate, current_user: User = Depends(get_current_user), db=Depends(get_database)):
